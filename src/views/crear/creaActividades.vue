<template>
  ...
  >
      ...
      <v-avatar
            color="red"
            size="30"
            style="float:right;margin-right:-350px;margin-left:150px;margin-top:10px; "
          >
            ...
            <v-row >
              ...
              <v-card class="elevation-12 mt-10" color="transparent">
                ...
                <v-row style="width: 500px; margin-left: 20px;">
                  <v-text-field
                   :error-messages="alertTareaTitulo"
                    dense
                    rounded
                    background-color="#f6f2f2"
                    label="Titulo"
                ...
                <v-row style="width: 500px; margin-left: 20px; ">
                  <v-textarea
                      :error-messages="alertTareaDescription"
               ...
               <v-row style="width: 600px; margin-left: 20px;">
                    ...
                    <v-file-input
                    :error-messages="alertTareaArchivo"
                    :success-messages="alertTareaArchivoAWS"
                        show-size
                        v-model="archive"
                  ...
                  -->
                    ...
                    <v-text-field
                     background-color="#D4D4D4"
                      style=" margin-left:20px; margin-right: 20px; font-weight: bold; width: 120px;"
                      v-model="tareaState"
              ...
              <v-card class="elevation-12 mt-10" color="transparent">
                <v-row style="width: 170px; margin-left: 20px; margin-right: 60px; padding-top: 40px;" >
                  <h5>Para</h5>
                   <v-text-field
                     background-color="#D4D4D4"
                      style=" margin:0px; font-weight: bold; width: 100%;"
                      v-model="TareaItemsAsignature"
                      label="Asignatura"
                      readonly
                      outlined
                      dense
               ...
               <!-- <v-row style="width: 90px; margin-left: 20px;">
                ...
                <v-row style="width: 190px; margin-left: 20px; margin-right: 40px;">
                  ...
                  <v-text-field
                  :error-messages="alertFechaInicio"
                ...
                <v-row style="width: 190px; margin-left: 20px; margin-right: 40px;">
                  ...
                  <v-text-field
                  :error-messages="alertFechaFinal"
                    style="border-radius: 18px;"
                    background-color="#f6f2f2"  
                    persistent-placeholder
                    outlined
